...
// Version 2 - Polished Luxury Edition
// Fixes: No hyphenation, better spacing, proper caps, more dynamism
...
#set text(
  ...
  fill: rich-black,
  lang: "en",
  hyphenate: false  // NO HYPHENATION - user hates broken words
)

#set par(
  justify: true,
  leading: 0.8em,  // Better spacing
  first-line-indent: 1.8em,
  spacing: 0.7em   // Consistent paragraph spacing
)
...
#let insight-box(title, content) = {
  ...
  block(
    ...
    inset: 0.35in,
    radius: 4pt,
    fill: warm-amber.lighten(92%),
    stroke: (top: 2.5pt + warm-amber, bottom: 2.5pt + warm-amber),
    {
      set par(first-line-indent: 0em, leading: 0.7em, hyphenate: false)

      text(
        size: 11.5pt,
        weight: "bold",
        fill: warm-amber.darken(35%),
        tracking: 1pt,
        smallcaps(title)
      )
      ...
      text(size: 11pt, fill: rich-black, content)
    }
  )
  v(0.35in)
}
...
#let lab-note(content) = {
  ...
  block(
    width: 100%,
    inset: (left: 0.45in, right: 0.45in, top: 0.25in, bottom: 0.25in),
    fill: deep-slate.lighten(94%),
    stroke: (left: 2.5pt + deep-slate),
    radius: 3pt,
    {
      corner-accent(color: deep-slate)
      set text(size: 10.5pt, fill: deep-slate.darken(5%), style: "italic")
      set par(first-line-indent: 0em, leading: 0.7em, hyphenate: false)
      content
    }
  )
