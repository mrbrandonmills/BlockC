...
// Include the exact title page from book-luxury-v4.typ
...
#page(margin: 1in, header: none, footer: context [#align(center)[PAGE #counter(page).display()]], fill: cream-bg)[
  #v(0.6in)
  ...
  #align(center)[
    ...
    // AUTHORS - Test if they appear on page 1
    #text(
      size: 18pt,
      weight: "bold",
      fill: rich-black,
    ...
    #text(size: 12pt, fill: rgb("#FF0000"), weight: "bold")[
      ← If you can read this text on PAGE 1, then the authors are visible on page 1
    ]
  ]
]
