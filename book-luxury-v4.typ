...
// Version 4 - PROPERLY FORMATTED
// Fixes: Authors on cover, chapter breaks, visual flow
...
// ============================================================================
// HEADING STYLES - CHAPTERS START ON NEW PAGES
// ============================================================================

#show heading.where(level: 1): it => {
  // FORCE NEW PAGE - chapters must start at top
  pagebreak()
...
#show heading.where(level: 3): it => {
  ...
  stack(
    ...
    line(length: 1.3in, stroke: 1.2pt + bright-cyan.lighten(15%))
  )
...
// ============================================================================
// TITLE PAGE - AUTHORS PROMINENTLY DISPLAYED
// ============================================================================
...
#page(margin: (top: 1.2in, bottom: 1in, left: 1in, right: 1in), fill: cream-bg)[
  #v(0.8in)
  ...
  #align(center)[
    ...
    #v(0.2in)
    #line(length: 2.8in, stroke: 1.2pt + deep-slate)
  ]
...
#align(center)[
  #box(
    ...
    #image("artwork-intro.svg", width: 100%)
  ]
]
#v(0.4in)
...
#block(inset: (left: 0.3in, right: 0.2in), {
  set par(first-line-indent: 0em, leading: 0.75em, spacing: 0.55em)
  ...
  grid(
    ...
    column-gutter: 12pt,
    align: (left, left),
    [#text(fill: bright-cyan, size: 14pt)[●]],
    [#text(weight: "bold", size: 11.5pt)[261.63 Hz (C): Peace, Reassurance, Grounding]

    #v(0.08in)

    #text(size: 11pt)[When he needed to settle his nervous system after a stressful day. When anxiety was running too high. When he needed to access calm without forcing it.]]
  )
  ...
  grid(
    ...
    align: (left, left),
    [#text(fill: bright-cyan, size: 14pt)[●]],
    [#text(weight: "bold", size: 11.5pt)[528 Hz (C♯): Transformation, DNA Repair, Love]

    #v(0.08in)

    #text(size: 11pt)[When he was working through something big. When he needed to access deeper layers of consciousness. When he was actively trying to shift patterns.]]
  )
  ...
  grid(
    ...
    align: (left, left),
    [#text(fill: bright-cyan, size: 14pt)[●]],
    [#text(weight: "bold", size: 11.5pt)[396 Hz (G): Liberation from Fear, Guilt]

    #v(0.08in)

    #text(size: 11pt)[When he was stuck in old narratives. When he needed to release something he'd been carrying too long.]]
  )
})
