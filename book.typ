...
// Typst Book Template
// Design: Laboratory Aesthetic - Scientific Notebook

// ============================================================================
// DESIGN SPECIFICATIONS
// ============================================================================
// Theme: Laboratory aesthetic - scientific notebook that's been lived in
// Colors:
//   - Primary: #2F4F4F (Deep Slate Gray)
//   - Accent: #00CED1 (Bright Cyan)
//   - Secondary: #FFB347 (Warm Amber)
// Typography:
//   - Headers: Montserrat Bold (fallback: sans-serif bold)
//   - Body: Georgia (classic serif)
//   - Page numbers: sans-serif light
// Book Format: 6x9 inches, ~210 pages
...
#set page(
  ...
  header: context {
    if counter(page).get().first() > 1 [
      #set text(9pt, fill: deep-slate.lighten(20%), font: "Georgia", style: "italic")
      #align(center)[
        #smallcaps[Block C: The Laboratory of Living]
      ]
      #v(-8pt)
      #line(length: 100%, stroke: 0.5pt + deep-slate.lighten(50%))
    ]
  },
  footer: context {
    ...
    if page-num > 1 [
      #line(length: 100%, stroke: 0.5pt + deep-slate.lighten(50%))
      #v(-6pt)
      #set text(10pt, fill: deep-slate, font: "Georgia")
  ...
  block(
    ...
    align(center)[
      ...
      #box(
        width: 2.5in,
        height: 3pt,
        fill: gradient.linear(bright-cyan, deep-slate, bright-cyan)
      )
      #v(0.3in)
  ...
  block(
    width: 100%,
    {
      ...
      grid(
        columns: (4pt, 1fr),
        column-gutter: 12pt,
        box(height: 100%, width: 4pt, fill: bright-cyan),
        text(
          size: 18pt,
          weight: "bold",
          fill: deep-slate,
...
#let pull-quote(content) = {
  ...
  block(
    width: 100%,
    inset: (left: 0.5in, right: 0.5in, top: 0.2in, bottom: 0.2in),
    stroke: (left: 3pt + bright-cyan),
    fill: bright-cyan.lighten(95%),
    {
...
// Section Divider with Geometric Element
#let section-divider() = {
  v(0.2in)
  align(center)[
    #grid(
      ...
      box(width: 12pt, height: 12pt, fill: bright-cyan),
      line(length: 100%, stroke: 0.5pt + deep-slate.lighten(40%))
    )
  ]
  v(0.2in)
...
// Emphasis box for key concepts
#let key-concept(title, content) = {
  v(0.25in)
  block(
    width: 100%,
    inset: 0.25in,
    radius: 4pt,
    stroke: 1.5pt + deep-slate.lighten(40%),
    fill: off-white,
    {
      set par(first-line-indent: 0em)
      text(
...
#align(center + horizon)[
  ...
  #box(
    width: 3in,
    height: 4pt,
    fill: gradient.linear(bright-cyan, warm-amber, bright-cyan)
  )
  ...
  #grid(
    ...
    column-gutter: 15pt,
    align: (horizon, center, horizon),
    line(length: 100%, stroke: 1pt + bright-cyan),
    box(width: 15pt, height: 15pt, fill: deep-slate),
    line(length: 100%, stroke: 1pt + bright-cyan)
  )
  ...
  #text(
    ...
    weight: "semibold",
    fill: deep-slate,
    [By Brandon Mills & Jesse Doherty]
  )
...
#align(center)[
  ...
  #link("https://www.selfactualize.life")\
  #link("https://www.brandonmills.com")
...
#v(1in)
#align(center)[
  #text(size: 24pt, weight: "bold", fill: deep-slate)[
    TABLE OF CONTENTS
  ]
]
#v(0.5in)
...
Introduction: The Laboratory of Living #h(1fr) 5

Chapter I: Moments of Permission #h(1fr) 16

Chapter II: Technology as Mirror #h(1fr) 36

Chapter III: The Awakening Crisis #h(1fr) 61

Chapter IV: Conscious Transformation #h(1fr) 86

Chapter V: Bridging the Gaps #h(1fr) 126

Chapter VI: The Integration #h(1fr) 161

Conclusion: The Invitation Forward #h(1fr) 196

#v(0.5in)
#align(center)[
  #box(width: 1.5in, height: 2pt, fill: bright-cyan)
]
